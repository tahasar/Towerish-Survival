...
namespace InventorySystem
{
    public class Inventory : MonoBehaviour
    {
        ...
        public ItemStack AddItem(ItemStack itemStack)
        {
            ...
            {
                throw new InventoryException(InventoryException.InventoryOperation.Add, "Inventory is Full");
            }
        ...
        public ItemStack RemoveItem(int atIndex, bool spawn = false)
        {
            if (!_slots[atIndex].HasItem)
                throw new InventoryException(InventoryException.InventoryOperation.Remove, "Slot is Empty");
        ...
        public ItemStack RemoveItem(ItemStack itemStack)
        {
            var itemSlot = FindSlot(itemStack.Item);
            if (itemSlot == null)
                throw new InventoryException(InventoryException.InventoryOperation.Remove, "No item in the Inventory");
            if (itemSlot.Item.IsStackable && itemSlot.NumberOfItems < itemStack.NumberOfItems)
            {
                throw new InventoryException(InventoryException.InventoryOperation.Remove, "Note enough Items");
            }
