...
namespace StatSystem.Editor
{
    public class StatDatabaseEditorWindow : EditorWindow
    {
        ...
        private static StatDatabase m_LastOpenedDatabase;
        ...
        public static bool OnOpenAsset(int instanceId, int line)
        {
            ...
            {
                m_LastOpenedDatabase = EditorUtility.InstanceIDToObject(instanceId) as StatDatabase;
                ShowWindow();
                return true;
            }
        ...
        {
            if (m_LastOpenedDatabase != null)
            {
                m_Database = m_LastOpenedDatabase;
                m_LastOpenedDatabase = null;
            }
            
            var temp = Selection.activeObject as StatDatabase;
            if (temp !=null)
            {
                m_Database = temp;
            }
        ...
        public void CreateGUI()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/StatSystem/Scripts/Editor/StatDatabaseEditorWindow.uxml");
            visualTree.CloneTree(root);
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Scripts/StatSystem/Scripts/Editor/StatDatabaseEditorWindow.uss");
