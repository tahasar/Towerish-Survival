...
namespace Source.Wraith_Karakteri.Vector_Parts.Spriter2UnityDX.Editor
{
    ...
    public class ERenderEdit : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var material =
                (Material)EditorGUILayout.ObjectField("Material", renderer.Material, typeof(Material), false);
            ...
            var sortIndex = EditorGUILayout.Popup("Sorting Layer", GetIndex(renderer.SortingLayerName), layerNames,
